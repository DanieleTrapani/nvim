My Neovim configuration, using [kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) as a base, and [lazy.nvim](https://github.com/folke/lazy.nvim) as the plugin manager.
